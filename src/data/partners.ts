...
import hudebninyMalin from "@/assets/loga/hudebniny_malin.png";
import agGroup from "@/assets/loga/ag_group.png";
...
export const corporatePartners: Partner[] = [
  ...
  { name: "Hudebniny Nový Malín", logo: hudebninyMalin },
  { name: "Ag", logo: agGroup },
];
